...
if (renderer === "word" && process.env.MD_PAGE_COUNT_TEST_WORD !== "1")
  throw new Error(
    "Set MD_PAGE_COUNT_TEST_WORD=1 to run the live Word release gate",
  );
if (
  renderer === "libreoffice" &&
  process.env.MD_PAGE_COUNT_TEST_LIBREOFFICE !== "1"
)
  throw new Error(
    "Set MD_PAGE_COUNT_TEST_LIBREOFFICE=1 to run the live LibreOffice release gate",
  );
const observations = [];
